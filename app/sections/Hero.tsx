...
export default function Hero() {
  return (
    <div className="relative w-full h-screen">
      <Image src="/kebuli.jpg" alt="Hero Image" fill priority sizes="100vw" className="object-cover object-center" />
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center space-y-3 text-center z-10 px-4">
        ...
        <Link
          href="https://wa.me/6281213407144?text=Halo%20saya%20ingin%20memesan%20katering"
          className="bg-primary-yellow border-2 border-black text-black px-5 sm:px-6 py-2 sm:py-3 rounded-full font-semibold hover:bg-opacity-90 transition duration-300 shadow-lg mt-5 text-sm sm:text-base cursor-pointer"
        >
